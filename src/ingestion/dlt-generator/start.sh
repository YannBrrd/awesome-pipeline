...
function start_demo() {
    ...
    ${PYTHON_CMD} generate.py --contract ../../../demo/contracts/contract.yaml --out demo-duckdb
...
EXEMPLES DE CONTRATS:
    ../../../demo/contracts/contract.yaml           - Pipeline DuckDB basique
    ../../../demo/contracts/contract-bigquery.yaml  - Pipeline BigQuery avancé
...
SUPPORT:
  Ce générateur fait partie de awesome-pipeline.
    Voir ../validation/README.md pour l'intégration complète.
EOF
    echo -e "${NC}"
}

...
def test_example_contracts():
    ...
    examples_dir = Path("../../1.Data_contract")
    if not examples_dir.exists():
        print("❌ Répertoire ../../1.Data_contract/ introuvable")
        return False
...
def main():
    ...
    if all_tests_passed:
        ...
        print("  python generate.py --contract ../../1.Data_contract/contract.yaml --out test-build")
        return 0
    else:

...
show_usage() {
    ...
    echo ""
    echo "Examples:"
    echo "  $0 bigquery ../1.Data_contract/contract.yaml ./bigquery-output"
    echo "  $0 databricks ../1.Data_contract/contract.yaml ./databricks-output"
    echo "  $0 snowflake ../1.Data_contract/contract.yaml ./snowflake-output"
    echo "  $0 postgres ../1.Data_contract/contract.yaml ./postgres-output"
    echo "  $0 duckdb ../1.Data_contract/contract.yaml ./duckdb-output"
}
